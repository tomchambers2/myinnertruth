...
Refinery::Resources.configure do |config|
  ...
  # config.dragonfly_secret = "0e103ddc203473e3b23cfa69b4a8d687bda7c6e37b2872dc"
  # config.dragonfly_url_format = "/system/resources/:job/:basename.:format"
  # config.dragonfly_url_host = ""
  # config.datastore_root_path = "/Users/tomchambers/projects/myinnertruth/public/system/refinery/resources"
